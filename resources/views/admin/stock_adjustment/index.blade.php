...
@section('main-content')
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Stock Adjustment List</h6>
            <ul class="d-flex align-items-center gap-2">
                <li class="fw-medium">
                    <a href="{{ route('stock_adjustment.index') }}" class="d-flex align-items-center gap-1 hover-text-primary">
            ...
            <div class="row justify-content-center ">
                <div class="col-lg-12">
                    ...
                    class="btn btn-danger delete_all">Delete</button> -->
                            ...
                            @if (isset(Auth::user()->hasPer('Stock Adjustment')['pcreate']) && Auth::user()->hasPer('Stock Adjustment')['pcreate'] == 1)
                                <a href="{{ route('stock_adjustment.create') }}" class="btn btn-success">Add New Adjustment</a>
                            @endif
                        </div>
                        <div class="card-body">
