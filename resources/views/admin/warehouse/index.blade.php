            ...
            <div class="row justify-content-center ">
                <div class="col-lg-12">
                    ...
                    class="btn btn-danger delete_all">Delete</button> -->
                            ...
                            @if (isset(Auth::user()->hasPer('Warehouse')['pcreate']) && Auth::user()->hasPer('Warehouse')['pcreate'] == 1)
                                <button type="button" class="btn btn-success create">Add New Warehouse</button>
                            @endif
                        </div>
                        <div class="card-body">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalAddLabel">New Warehouse</h5>
...
@section('script')
<script src="{{ asset('admin/myjs/warehouse/warehouse.js') }}"></script>
@endsection
