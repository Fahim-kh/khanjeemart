...
@section('main-content')
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Sale List</h6>
            ...
            <div class="row justify-content-center ">
                <div class="col-lg-12">
                    ...
                    class="btn btn-danger delete_all">Delete</button> -->
                            ...
                            @if (isset(Auth::user()->hasPer('Sale')['pcreate']) && Auth::user()->hasPer('Sale')['pcreate'] == 1)
                                <a href="{{ route('sale.create') }}" class="btn btn-success">Add New Sale</a>
                            @endif
                        </div>
                        <div class="card-body">
