...
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Supplier List</h6>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        @if (isset(Auth::user()->hasPer('Supplier')['pcreate']) && Auth::user()->hasPer('Supplier')['pcreate'] == 1)
                            <button type="button" class="btn btn-success create">Add New Supplier</button>
                        @endif
                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="modalAddLabel">New Supplier</h5>
...
@section('script')
<script src="{{ asset('admin/myjs/supplier/supplier.js') }}"></script>
@endsection
