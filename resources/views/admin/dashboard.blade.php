          ...
          <div class="d-flex flex-column gap-24">
            <div class="d-flex align-items-center justify-content-between gap-3">
              <div class="d-flex align-items-center">
                <img src="{{ asset('admin') }}/assets/images/user-grid/user-grid-img1.png" alt=""
            ...
            <div class="d-flex align-items-center justify-content-between gap-3">
              <div class="d-flex align-items-center">
                <img src="{{ asset('admin') }}/assets/images/user-grid/user-grid-img2.png" alt=""
                  class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center justify-content-between gap-3">
              <div class="d-flex align-items-center">
                <img src="{{ asset('admin') }}/assets/images/user-grid/user-grid-img3.png" alt=""
                  class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center justify-content-between gap-3">
              <div class="d-flex align-items-center">
                <img src="{{ asset('admin') }}/assets/images/user-grid/user-grid-img4.png" alt=""
                  class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                <div class="flex-grow-1">
